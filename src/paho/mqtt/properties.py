...
class Properties:
    ...
    def __init__(self, packetType):
        ...
        self.types = ["Byte", "Two Byte Integer", "Four Byte Integer", "Variable Byte Integer", "Binary Data", "UTF-8 Encoded String", "UTF-8 String Pair"]
        ...
        self.properties = {
            ...
            11: (self.types.index("Variable Byte Integer"), [PacketTypes.PUBLISH, PacketTypes.SUBSCRIBE]),
            17: (self.types.index("Four Byte Integer"), [PacketTypes.CONNECT, PacketTypes.CONNACK, PacketTypes.DISCONNECT]),
            18: (self.types.index("UTF-8 Encoded String"), [PacketTypes.CONNACK]),
            19: (self.types.index("Two Byte Integer"), [PacketTypes.CONNACK]),
            21: (self.types.index("UTF-8 Encoded String"), [PacketTypes.CONNECT, PacketTypes.CONNACK, PacketTypes.AUTH]),
            22: (self.types.index("Binary Data"), [PacketTypes.CONNECT, PacketTypes.CONNACK, PacketTypes.AUTH]),
            ...
            28: (self.types.index("UTF-8 Encoded String"), [PacketTypes.CONNACK, PacketTypes.DISCONNECT]),
            31: (
            ...
            33: (self.types.index("Two Byte Integer"), [PacketTypes.CONNECT, PacketTypes.CONNACK]),
            34: (self.types.index("Two Byte Integer"), [PacketTypes.CONNECT, PacketTypes.CONNACK]),
            ...
            39: (self.types.index("Four Byte Integer"), [PacketTypes.CONNECT, PacketTypes.CONNACK]),
    ...
    def __setattr__(self, name, value):
        ...
        if name in privateVars:
            ...
            if not isinstance(value, list):
                ...
                elif name in ["MaximumPacketSize", "SubscriptionIdentifier"] and (value < 1 or value > 268435455):
                    raise MQTTException(f"{name} property value must be in the range 1-268435455")
                elif name in ["RequestResponseInformation", "RequestProblemInformation", "PayloadFormatIndicator"] and (value != 0 and value != 1):
