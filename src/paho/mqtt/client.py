...
class Client(object):
    ...
    * Use disconnect() to disconnect from the broker
    ...
    def __init__(self, client_id="", clean_session=True, userdata=None, protocol=MQTTv31):
        ...
        self.on_disconnect = getattr(self, 'on_disconnect', None)
        self.on_connect = getattr(self, 'on_connect', None)
        self.on_publish = getattr(self, 'on_publish', None)
        self.on_message = getattr(self, 'on_message', None)
        self.on_message_filtered = []
        self.on_subscribe = getattr(self, 'on_subscribe', None)
        self.on_unsubscribe = getattr(self, 'on_unsubscribe', None)
        self.on_log = getattr(self, 'on_log', None)
        self._host = ""
        self._port = 1883
        self._bind_address = ""
